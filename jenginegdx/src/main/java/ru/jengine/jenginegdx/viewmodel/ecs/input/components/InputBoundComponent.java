...
@ExternalAddable("inputBound")
public class InputBoundComponent extends PooledComponent implements CanBeFilling<InputBoundComponent> {
    private float width;
    ...
    @Override
    public boolean fill(InputBoundComponent other) {
