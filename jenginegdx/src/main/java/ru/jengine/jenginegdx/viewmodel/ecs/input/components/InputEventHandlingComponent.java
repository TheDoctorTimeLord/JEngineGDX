...
@ExternalAddable("inputEventHandling")
public class InputEventHandlingComponent extends Component implements CanBeFilling<InputEventHandlingComponent> {
    private final Map<String, String[]> eventHandling = new HashMap<>();

    public InputEventHandlingComponent addHandling(String event, String... handle) {
    ...
    @Override
    public boolean fill(InputEventHandlingComponent other) {
